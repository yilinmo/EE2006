...
\end{align}
Thus, *All* the solution of \eqref{eq:pde3b} will equal to the particular solution \eqref{eq:pde3soln} plus the general solution for the homogenous equation \eqref{eq:per3homosolun}, i.e.,
\begin{align}
